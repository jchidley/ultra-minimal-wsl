...
Stock WSL 2.7.12 calibration passed `B6-T` with independent recovery in `CP-STOCK-2.7.12-003`. The non-runtime `minimal-v3-stock-ns` Windows package build and exact installation/recovery runner validation are complete: MSI SHA-256 `e9c41512246db9afe15a150a83f457ddd8087479225fee63f1e4a32c5ec8fe77`, runner SHA-256 `357e77322499c2874a1cf813611b6a06cb04f700f7e6f199e6074e0644207e9f`, fixture Off. The package has not been installed and the reserved trial has not run. The next action is the runtime trial after inventory integrity reports `ok`; no separate human review or execution-gate opening is required. Keep the accepted probe, rootfs, timeouts, instrumentation, evidence schema, classification rules, and recovery requirements unchanged.
