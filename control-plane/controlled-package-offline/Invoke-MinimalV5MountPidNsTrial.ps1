...
$TrialId = 'CP-MINIMAL-V5-MOUNT-PID-NS-001'
...
$CandidateManifest = Join-Path $InputRoot 'trial-manifests\minimal-v5-mount-pid-ns.json'
...
$CandidateManifestSha256 = '2f6dd1c0e81079bd98dfadf5ee56a8bc98b2f62f872e9adaa2a13eac192ceb26'
$OutputManifestSha256 = '67385cee129cb4c39dfb909304448b934a31a7bda0ea09948602578414017569'
...
function Invoke-FixedProbe([bool]$Recovery) {
    ...
    $candidateId = if ($Recovery) { 'stock-wsl-2.7.12-recovery' } else { 'minimal-v5-mount-pid-ns' }
...
function Assert-FixedInputs {
    ...
    if ($manifest.candidate_id -ne 'minimal-v5-mount-pid-ns' -or
