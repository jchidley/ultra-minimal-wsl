...
$TrialId = 'CP-MINIMAL-V6-K-PIDNS-001'
...
$CandidateManifest = Join-Path $InputRoot 'trial-manifests\minimal-v6-k-pidns-001.json'
...
$CandidateManifestSha256 = 'b5e0753fb760d7e5181a0db9fd26abb04ea668bf1602e1fe86ae5566942cd109'
...
function Invoke-FixedProbe([bool]$Recovery) {
    ...
    $candidateId = if ($Recovery) { 'stock-wsl-2.7.12-recovery' } else { 'minimal-v6-k-pidns-001' }
...
function Assert-FixedInputs {
    ...
    if ($manifest.candidate_id -ne 'minimal-v6-k-pidns-001' -or
