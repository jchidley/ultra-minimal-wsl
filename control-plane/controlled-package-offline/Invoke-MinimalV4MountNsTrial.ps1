...
$TrialId = 'CP-MINIMAL-V4-MOUNT-NS-001'
$InputRoot = 'C:\controlled-inputs\ultra-minimal-wsl'
$EvidenceParent = 'C:\controlled-wsl-trials'
$CandidatePackage = Join-Path $InputRoot 'candidate-packages\minimal-v4-mount-ns\wsl.msi'
$CandidateManifest = Join-Path $InputRoot 'trial-manifests\minimal-v4-mount-ns.json'
...
$CandidateProductCode = '{13294BEB-3E05-4814-A642-84742C1DAFAF}'
...
$CandidatePackageSha256 = '0348f46804735773cb89d1d25908f950402b69c9a76435634dc5af9633dd2518'
$CandidateManifestSha256 = 'b7fa44a0168c00cdb75d1fb6b8c0bddbb6685083f0b13a6c5a40c3ba022a6312'
$OutputManifestSha256 = 'db215c6136ebf8faebd93b5ffb17b742cb365c4b0a3c968732c98f02b6593e61'
$CompleteSourceDiffSha256 = '1978046984db35fd2a6de46aa53da6d3de17793bf163c262b222dc9e959da13a'
...
function Invoke-FixedProbe([bool]$Recovery) {
    ...
    $candidateId = if ($Recovery) { 'stock-wsl-2.7.12-recovery' } else { 'minimal-v4-mount-ns' }
...
function Assert-FixedInputs {
    ...
    if ($manifest.candidate_id -ne 'minimal-v4-mount-ns' -or
