...
$TrialId = 'CP-MINIMAL-V4-STOCK-NS-001'
$InputRoot = 'C:\controlled-inputs\ultra-minimal-wsl'
$EvidenceParent = 'C:\controlled-wsl-trials'
$CandidatePackage = Join-Path $InputRoot 'candidate-packages\minimal-v4-stock-ns\wsl.msi'
$CandidateManifest = Join-Path $InputRoot 'trial-manifests\minimal-v4-stock-ns.json'
...
$CandidateProductCode = '{929334FC-D0AF-423B-A33D-0068D4AC506B}'
...
$CandidatePackageSha256 = '50f17bd74d3b5aafb4f48507ad926b2f003255db55d463117a23bc2890206cda'
$CandidateManifestSha256 = 'a200746e4887f2106390f3e3e421bdcbcab247e7dd5b0ccec69627d277649949'
$OutputManifestSha256 = 'b8d887ff736bbe085825be52af3da45dc0767ca9d87e1da304d80f694d8f1826'
$CompleteSourceDiffSha256 = 'ee84b110ce27bbe9972315227fe3039da121e1d2e533e094e4c3a35bd6b6a6a5'
...
function Invoke-FixedProbe([bool]$Recovery) {
    ...
    $candidateId = if ($Recovery) { 'stock-wsl-2.7.12-recovery' } else { 'minimal-v4-stock-ns' }
...
function Assert-FixedInputs {
    ...
    if ($manifest.candidate_id -ne 'minimal-v4-stock-ns' -or
