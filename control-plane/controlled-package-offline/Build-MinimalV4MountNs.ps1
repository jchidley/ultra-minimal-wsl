...
$SourceRoot = 'C:\controlled-package\source\minimal-v4-mount-ns'
$BuildRoot = 'C:\controlled-package\build\minimal-v4-mount-ns'
...
$ExpectedCompleteDiffSha256 = '1978046984db35fd2a6de46aa53da6d3de17793bf163c262b222dc9e959da13a'
$Patches = [ordered]@{
    ...
    '0005-minimal-v3-mount-ns.patch' = '7bf14daf6388b322db5bf69eb05394f84baa3260b3c1127efaae0fc62e473515'
}
$ExpectedOutputs = @(
