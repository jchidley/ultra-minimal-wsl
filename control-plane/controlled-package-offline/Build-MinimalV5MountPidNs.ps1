...
$Candidate = 'minimal-v5-mount-pid-ns'
...
$SourceRoot = 'C:\controlled-package\source\minimal-v5-mount-pid-ns'
$BuildRoot = 'C:\controlled-package\build\minimal-v5-mount-pid-ns'
...
$ExpectedCompleteDiffSha256 = 'cfd8cd05bd302f2a0c3f40f3f3266c6a992e6a0275d873ad66cd2a94b211efe8'
$Patches = [ordered]@{
