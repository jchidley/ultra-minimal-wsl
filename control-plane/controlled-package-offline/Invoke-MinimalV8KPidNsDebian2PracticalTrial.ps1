...
$TrialId = 'CP-MINIMAL-V8-K-PIDNS-DEBIAN2-PRACTICAL-001'
...
$CandidateProbe = Join-Path $InputRoot 'procedure\Invoke-WslDebian2PracticalProbe.ps1'
$RecoveryProbe = Join-Path $InputRoot 'procedure\Invoke-WslCandidateProbe.ps1'
$ArticleVhdx = Join-Path $InputRoot 'registered-distros\Debian2\ext4.vhdx'
...
$CandidateProbeSha256 = 'feedb4f54297305d5ca1baa2e44dedbc2979b1e09ade73c6768d2fe93e16522d'
$RecoveryProbeSha256 = '424b0d4f26cef5c717a4805b2577feebf6973de4656778d7800474aad1bf4ebb'
$ArticleVhdxSha256 = '0c803f68d7cb3b0f8e0b29022df5413a43bd96bcb0a947f47712155d1895d388'
...
function Assert-FixedInputs {
    ...
    Assert-Hash $ArticleVhdx $ArticleVhdxSha256
    if ((Get-Item -LiteralPath $ArticleVhdx).Length -ne 1473249280) { throw 'Debian2 article VHDX size mismatch.' }
...
function Invoke-Recovery([System.Collections.Generic.List[string]]$Failures) {
    ...
    try {
        ...
        Invoke-StockArticleVerification
    }
...
$plan = [ordered]@{
    ...
    candidateGate = 'P6-PI-PACKAGE'; candidateDistribution = 'Debian2'; candidateSmoke = 'six ordered offline practical-workload checkpoints'
    recoveryGate = 'B6-T'; recoveryDistribution = 'Toybox-Minimal'; diagnosticDebugConsole = $true
    note = 'One serial offline comparison of the retained Debian2 article under frozen ultra-minimal-wsl-v1, followed by exact Toybox stock recovery and retained-article verification under stock.'
}
