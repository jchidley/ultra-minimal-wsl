...
$TrialId = 'CP-MINIMAL-V5-K-PIDNS-001'
...
$CandidateManifest = Join-Path $InputRoot 'trial-manifests\minimal-v5-k-pidns-001.json'
...
$CandidateManifestSha256 = 'e3bd73bd70be85dcecf73e5baeb78ce4f5711c1a32ed9c853f1a840ce1ea1134'
...
function Invoke-FixedProbe([bool]$Recovery) {
    ...
    $candidateId = if ($Recovery) { 'stock-wsl-2.7.12-recovery' } else { 'minimal-v5-k-pidns-001' }
...
function Assert-FixedInputs {
    ...
    if ($manifest.candidate_id -ne 'minimal-v5-k-pidns-001' -or
