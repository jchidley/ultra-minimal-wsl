...
- The `minimal-v4-mount-ns` build completed with pinned offline inputs, extracted identities independently reverified, and final fixture Off. Its runner has not installed or probed the candidate: all 13 local fault injections pass, while two fresh-ID fixture-validation launches stopped before worker start.
